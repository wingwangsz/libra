...
async fn agent_checkpoint_paging_up_down_up_round_trip() {
    ...
    assert_eq!(
        rolled,
        vec![2026071403, 2026071402, 2026071401, 2026071301, 2026070803, 2026070802]
    );
    for index in paging_indexes {
        assert!(
    ...
    assert_eq!(
        reapplied,
        vec![2026070802, 2026070803, 2026071301, 2026071401, 2026071402, 2026071403]
    );
    for index in paging_indexes {
        assert!(
            index_exists(&conn, index).await,
